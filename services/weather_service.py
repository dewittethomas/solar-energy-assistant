...
class WeatherService:
    ...
    def get_historical_weather(self, latitude: float, longitude: float, timezone: str,
                           start_date: str, end_date: str) -> Dict[str, Any]:
        return self.repository.fetch_historical_data(latitude, longitude, timezone, start_date, end_date)
